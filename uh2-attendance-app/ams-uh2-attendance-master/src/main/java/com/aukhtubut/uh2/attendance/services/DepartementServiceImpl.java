...
public class DepartementServiceImpl implements DepartementService {
    @Value("${platform.rest.data.departement}")
    private String resourceRestUrl;

    @Value("${platform.rest.data.departement.fields}")
    ...
    public DepartementDtoExtArray getDepartements() {
        ...
        return client.get()
                ...
                .retrieve()
                .bodyToMono(DepartementDtoExtArray.class).block();
    }
    ...
    public DepartementDtoExt getDepartementByName(String name) {
        ...
        return client.get()
                ...
                .bodyToMono(DepartementDtoExt.class)
